...
pas_ope_srv.setControl(txtPas_ID, txtPas_Name, ClnOpe_Date, Cmb_opeType, Cmbope_Nurse, Cmbope_Doctor, txt_opeCost, CmbConvrt_Doc, CmbAssist_Doctor, CmbAnthes_Type, CmbAneths_Doctor, txt_opeCost);
...
txtPas_ID.setText(pas_ope_srv.getNom(Pas_id)+""); }
    catch(Exception e){System.out.println(e);}
}
