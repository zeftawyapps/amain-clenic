 ...
 * @author aman
 */
public class Frm_InsCompany extends javax.swing.JFrame {

public String file_id="1"; 

public Frm_InsCompany() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnl_InsCompany1 = new Doctor_Files.pnl_InsCompany();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnl_InsCompany1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(pnl_InsCompany1, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
...
boolean isAddnew;
    private void btnAddnewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddnewActionPerformed
        pnl_InsCompany1.Addnew();
        isAddnew=true;
    }//GEN-LAST:event_btnAddnewActionPerformed

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if(isAddnew){
            pnl_InsCompany1.Insert();
            isAddnew=false;
            ...
            try {
                pnl_InsCompany1.update();
            } catch (SQLException ex) {
                Logger.getLogger(Frm_InsCompany.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ParseException ex) {
                Logger.getLogger(Frm_InsCompany.class.getName()).log(Level.SEVERE, null, ex);
            }
}
        try {
            pnl_InsCompany1.loadData();
        } catch (SQLException ex) {
    ...
    private void MPbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MPbtnActionPerformed
        pnl_InsCompany1.movepre();
        file_id = pnl_InsCompany1.doc_id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_InsCompany.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_InsCompany().setVisible(true);
            }
        });
    }
    ...
    private Doctor_Files.pnl_InsCompany pnl_InsCompany1;
