...
/*      TreatRequest2.setValue(TrQust2); //11
  ...
  this.Name,TypeService,ExamType,TreatDoctor,TimeVisit,
   ...
   NxVstDate,StatueDetails,TreatRequest1
   };
...
public  void movelast()
{
    dataTableShow.Movelast();
       ...
       TypeService.setShowInTable(true, "نوع الخدمة");
       ExamType.setShowInTable(true,"نوع الكشف");
       TreatDoctor.setShowInTable(true,"الطبيب المعالج ");         
       TimeVisit.setShowInTable(true,"حالة الزيارة ");
       DateVisit.setShowInTable(true,"تاريخ الزيارة");
       ConvertDoctor.setShowInTable(true, "الطبيب المحول");
       ExamValue.setShowInTable(true, "قيمة الكشف");
       Drugs.setShowInTable(true, "الادوية");
       NxVstDate.setShowInTable(true, "تاريخ الزيارة القادمة");
       StatueDetails.setShowInTable(true, "تفاصيل الحالة");
      TreatRequest1.setShowInTable(true, "حالة الطلب 1");
      
      Cell[] dataCells=new Cell[]
       {ID,this.Name,TypeService,ExamType,TreatDoctor,TimeVisit,
   DateVisit,ConvertDoctor,ExamValue,Drugs,
   NxVstDate,StatueDetails,TreatRequest1};
      DefaultTableModel d=dataTableShow.ShowData();
          close();
          return  d;
...
dataTableShow.FillControls();
    ...
    public  Z_DataFillShow_swing LoadFile(String id) throws SQLException, ParseException{
       Cell [] maindataCells;
   maindataCells =  new Cell[]    
       {this.Name,TypeService,ExamType,TreatDoctor,TimeVisit,
   DateVisit,ConvertDoctor,ExamValue,Drugs,
   NxVstDate,StatueDetails,TreatRequest1};
   ...
   Cell Wherecell[];
   PasData_id.SetWhere(setwhere.Equl, setAndor.And,id);
    Wherecell =  new Cell[]{this.PasData_id};
    setCells(maindataCells,Wherecell);
   dataTableShow= showDattaFill(Load_Where());  
