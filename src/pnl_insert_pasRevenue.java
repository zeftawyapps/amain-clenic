...
pasRevenue.setControl(txt_pasID, txt_pasName, cln_ExamDate, cmb_ExamType, txt_ExamValue, txt_pasValue, txt_InsValue, txt_ope, txt_Consum, txt_srv, txt_Total, txt_percent);
...
Pas_id=txt_pasID.getText();
                ...
                void insert(){
try{ pasRevenue.pationtDataInsert();
}catch(Exception ex){
    ...
    void update(){
    try{pasRevenue.pationtDataUpdate(Pas_id);}
    catch(Exception e){System.out.println(e);}
    }
    
        void delete(){
    try{pasRevenue.deletfile_id(Pas_id);}
    catch(Exception e){System.out.println(e);}
    }
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(cln_ExamDate, javax.swing.GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)
