...
public class AmanPasDatabse_PasdataFile extends Z_DataTable{
    ...
    public void PationtFileData(String pasid ,  String Name ,
  
     String examType,String ExampValu, String treatDoc,String timeVist,
      String dateVist, String nxtVistDate,
      String drugs,
      String details, String TrQust1
     ) throws SQLException, ParseException, IOException          
{
  
   this.Name.setValue(Name);//1
PasData_id.setValue(pasid);
   ExamType.setValue(examType); //3
 ExamValue.setValue(ExampValu);
 ...
 Drugs.setValue(drugs); //8
   ...
   { PasData_id , 
  this.Name,ExamType,TreatDoctor,TimeVisit,
   DateVisit,ExamValue,Drugs,
